...
export default [
  {
    ...
    outputFile: '/output/accommodation_base_registry.ttl',
    query: `
...
`;
  ...
  },
  {
    ...
    outputFile: '/output/base_registry.ttl',
    query: `
SELECT business_product_id,
parent_product_ids,
name, name_or_number,
...
`,
  ...
  },
  {
    ...
    outputFile: '/output/promotional_info_nl.ttl',
  ...
  },
  {
    ...
    outputFile: '/output/promotional_info_en.ttl',
  ...
  },
  {
    ...
    outputFile: '/output/promotional_images.ttl',
    query: `
